class Edge extends React.Component { // eslint-disable-line no-unused-vars
    pixels() {
        ...
        for (let pixel = 0; pixel < this.props.pixels; pixel++) {
            ...
            pixels.push(<Pixel id={ pixel } bgcolor={bgcolor} side={ this.props.side } key={ `pixel-${this.props.side}-${pixel}` } selectionColor={this.props.selectionColor} />);
        }
